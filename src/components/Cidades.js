...
import { Form, Alert, InputGroup, Button, ButtonGroup, Container, Row, Col, Navbar } from "react-bootstrap";
import CidadesDataService from "./services/cidades.services";
import ListCidade from "./ListCidade";

 //function Cidades(){
const Cidades = ({ id, setCidadeId }) => {
    ...
    return (
        ...
        <Row>
          <Col>
                <ListCidade getCidadeId={getCidadeIdHandler}/>
          </Col>
        </Row>    
        </Container>
      </>
